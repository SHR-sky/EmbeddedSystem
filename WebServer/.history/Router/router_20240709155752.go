...
func GetSysInfo() {
	...
	strconv.Itoa(int(vmStat.Free)) + "\n" + 
	strconv.Itoa(int(vmStat.UsedPercent)) + "\n"
	partitions, _ := disk.Partitions(false)
	for _, partition := range partitions {
		info += (partition.Mountpoint + "\n")
		usage, _ := disk.Usage(partition.Mountpoint)
		info += (strconv.Itoa(int(usage.Total)) + "\n")
		info += (strconv.Itoa(int(usage.Free)) + "\n")
		info += (strconv.Itoa(int(usage.Used)) + "\n")
		info += (strconv.Itoa(int(usage.UsedPercent)) + "\n")
		break
	}
	fmt.Print(info)
}